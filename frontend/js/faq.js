...
var faqItems = [
    ...
    { cat: "Platforma", question: 'Ce inseamna „Deschis" si „Cu aprobare" la statusul unui grup?', answer: 'Un grup „Deschis" permite oricui sa se alature direct, fara aprobare. Un grup „Cu aprobare" necesita ca administratorul sa accepte fiecare cerere de alaturare. Este util cand grupul doreste sa selecteze membrii pe baza unor criterii specifice (buget, zona preferata, viziune compatibila).' },
    ...
    // === TEREN & CONSTRUCTIE (6) ===
    { cat: "Teren", question: "Cum gasim un teren potrivit?", answer: "Platforma ofera o sectiune dedicata propunerilor de terenuri, unde membrii pot propune si evalua terenuri disponibile. La evaluarea unui teren se ia in considerare: zona preferata; suprafata (de exemplu Judetului Housing are 6 apartamente de 2-3 camere pe un teren de 460 mp); pentru grupuri mici se recomanda terenuri de minim 500 mp, frontul la strada minim 10-12 m; numarul de calcane vecine pe limita de proprietate (de preferat maxim 1-2 calcane, care pot fi de fapt o oportunitate de eficientizare a terenului, prin lipirea constructiei noi la ele); forma terenului sa nu fie extrem de neregulata. Se poate cere o analiza generala de pe platforma pentru a vedea ce se poate construi pe un anumit teren: suprafete construite, utile, regim de inaltime, retrageri fata de limitele de proprietate, numar aproximativ de apartamente." },
